...
#define HFORWARD ako::HaarHorizontalForward
#define HINVERSE ako::HaarHorizontalInverse
#define VFORWARD ako::HaarVerticalForward
#define VINVERSE ako::HaarInPlaceishVerticalInverse
...
int main()
{
	...
	HorizontalTest(4, true, HFORWARD, HINVERSE, DataGeneratorMostlyRandom<int16_t>);
	VerticalTest(4, true, VFORWARD, VINVERSE, DataGeneratorMostlyRandom<int16_t>);

	HorizontalTest(3, true, HFORWARD, HINVERSE, DataGeneratorMostlyRandom<int16_t>);
	VerticalTest(3, true, VFORWARD, VINVERSE, DataGeneratorMostlyRandom<int16_t>);
	HorizontalTest(2, true, HFORWARD, HINVERSE, DataGeneratorMostlyRandom<int16_t>); // Minimum length
	VerticalTest(2, true, VFORWARD, VINVERSE, DataGeneratorMostlyRandom<int16_t>);   // Ditto
