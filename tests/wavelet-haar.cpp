...
#define FORWARD ako::HaarHorizontalForward
#define INVERSE ako::HaarHorizontalInverse
...
int main()
{
	...
	HorizontalTest(4, true, FORWARD, INVERSE, DataGeneratorRandom<int16_t>);

	HorizontalTest(3, true, FORWARD, INVERSE, DataGeneratorRandom<int16_t>);
	HorizontalTest(2, true, FORWARD, INVERSE, DataGeneratorRandom<int16_t>); // Minimum length
