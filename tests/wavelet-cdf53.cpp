...
int main()
{
	...
	HorizontalTest(ako::CDF53_MINIMUM_LENGTH + 1, true, HFORWARD, HINVERSE, DataGeneratorMostlyRandom<int16_t>);
	VerticalTest(ako::CDF53_MINIMUM_LENGTH + 1, true, VFORWARD, VINVERSE, DataGeneratorMostlyRandom<int16_t>);
